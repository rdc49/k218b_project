...
#     && sleep 3 \
#     && tmux send-keys -t vulcan_rerun 'bash /data/rdc49-2/K218b_project/grid_sweep_configs/vulcan_rerun_configs/full_run_20260730/cap003b/launch_cap003b.sh <max_jobs>' C-m"
#
