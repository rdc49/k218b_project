...
#     && sleep 3 \
#     && tmux send-keys -t vulcan_rerun 'bash /data/rdc49-2/K218b_project/grid_sweep_configs/vulcan_rerun_configs/full_run_20260730/cap005a/launch_cap005a.sh <max_jobs>' C-m"
#
