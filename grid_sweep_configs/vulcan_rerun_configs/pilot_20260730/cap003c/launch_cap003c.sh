...
#     && sleep 3 \
#     && tmux send-keys -t vulcan_rerun 'bash /data/rdc49-2/K218b_project/grid_sweep_configs/vulcan_rerun_configs/pilot_20260730/cap003c/launch_cap003c.sh <max_jobs>' C-m"
#
